...
const Ejemplo2 = () => {
  ...
  // Vamos a crear una referencia con useRef() para asociar a una variable con un elemento del DPM del
   ...
   * Cada vez que haya un cambio en contador 1, se ejecuta lo que diga el useEffects()
   ...
   * Cada vez que haya un cambio en contador 1, se ejecuta lo que diga el useEffects()
   * Cada vez que haya un cambio en contador 2, se ejecuta lo que diga el useEffects()
   */
